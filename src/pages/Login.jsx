...
const [showPassword, setShowPassword] = useState(false);
  ...
  return (
    ...
    <Container>
      ...
      <div className="w-full max-w-[520px] h-[430px]  bg-white p-6 rounded-md shadow-sm border border-gray-200">
        ...
        <p className="text-center text-[#666666] text-[16px] font-pop mt-8">
          Don’t have account? <Link className='font-medium text-4 font-pop text-[#1A1A1A]' to="/Registation">Register</Link>
        </p>
